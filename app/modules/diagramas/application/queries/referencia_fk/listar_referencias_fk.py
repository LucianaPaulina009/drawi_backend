...
class ListarReferenciasFKQuery:
    propietario_id: str
    relacion_id: UUID


class ListarReferenciasFKQueryHandler:
    def __init__(
        self,
    ...
    def execute(self, query: ListarReferenciasFKQuery) -> list[ReferenciaFKDTO]:
        ...
        referencias = self.referencia_fk_repository.listar_por_relacion(query.relacion_id)

...
class DesbloquearColaboradorCommand:
    propietario_id: str
    proyecto_id: UUID
    colaborador_id: UUID


class DesbloquearColaboradorUseCase:
    """Caso de uso para desbloquear a un colaborador en un proyecto propio (restaurando estado activo)."""
    ...
    def execute(self, command: DesbloquearColaboradorCommand) -> None:
